# 🕵️ GHOST-X: First Round Writeups

Welcome to the official repository for **Team GHOST-X**. This repo contains the technical writeups and solutions for the first round of the **CryptX CTF**.

We successfully cleared **9 out of 10** challenges, covering domains from Network Forensics to OSINT and Reverse Engineering.

-----

## 👥 The Team: GHOST-X

We are a 4-member team of security enthusiasts and analysts:
...
During this round, our team utilized a diverse toolkit to "peel" through the layers of each challenge:

  * **Forensics:** `Wireshark`, `tshark`, `binwalk`, `exiftool`, `steghide`
  * **Reverse Engineering:** `JADX-GUI`, `Bytecode Viewer`
  * **OSINT:** `Wayback Machine`, `GitHub Gists`, `Google Dorking`
  * **Scripting:** `Python` (NumPy, Matplotlib for Signal Processing), `Bash` (Automation)
  * **Crypto:** `John the Ripper`, `Base32/64 Decoders`
...
```text
.
├── README.md                 # Team info and Challenge Index
├── brute-brute.md            # Password cracking solution
├── lactose-&-lies.md         # Image steganography solution
├── magic-peeler.md           # Nested archive extraction
├── obfuscated-cells.md       # Script analysis
├── shards-of-the-signal.md   # Base32 and chunking logic
├── the-breach.md             # Android APK reversal
├── the-chimera-vault.md      # OSINT and Git history
├── the-network-fragments.md  # ICMP packet analysis
└── the-rogue-architect.md    # Audio phase inversion & spectrograms
```
